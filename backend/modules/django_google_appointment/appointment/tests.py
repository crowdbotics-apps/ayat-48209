...
class GoogleAppointmentTestCases(APITestCase):
    ...
    @mock.patch(
        "modules.django_google_appointment.appointment.services.GoogleAppointmentServices.GoogleAppointmentService.appointment_list"
    )
    def test_get_appointment_list(self, appointment_list_mock):
        responses = {
            "kind": "calendar#events",
            "etag": '"p32cb5mvchjevo0g"',
            "summary": "johny1122@gmail.com",
            "updated": "2023-01-23T06:49:39.103Z",
            "timeZone": "Asia/Karachi",
            "accessRole": "owner",
            "defaultReminders": [{"method": "popup", "minutes": 30}],
            "nextSyncToken": "CJiy2-yM3fwCEJiy2-yM3fwCGAUg7JnJ7wE=",
            "items": [
                {
                    "kind": "calendar#event",
                    "etag": '"3301560614520000"',
                    ...
                    "created": "2022-04-24T06:05:07.000Z",
                    "updated": "2022-04-24T06:05:07.260Z",
                    ...
                    "start": {
                        "dateTime": "2022-04-25T22:00:00+05:00",
                        "timeZone": "Asia/Karachi",
                    },
                    "end": {
                        "dateTime": "2022-04-25T23:00:00+05:00",
                        "timeZone": "Asia/Karachi",
                    },
    ...
    @mock.patch(
        "modules.django_google_appointment.appointment.services.GoogleAppointmentServices.GoogleAppointmentService.single_appointment"
    )
    def test_get_single_appointment(self, single_appointment_mock):
        responses = {
            "kind": "calendar#event",
            "etag": '"3343249581594000"',
            "id": "flp51c1hgj5l62389rh7cj763c",
            "status": "confirmed",
            "htmlLink": "https://www.google.com/calendar/event?eid=ZmxwNTFjMWhnajVsNjIzODlyaDdjajc2M2MgamFtZ2hhZm9vcjExMjJAbQ",
            "created": "2022-12-21T12:13:10.000Z",
            "updated": "2022-12-21T12:13:10.797Z",
            "summary": "Demo 2",
            "description": "Demo 2 meeting description",
            "creator": {"email": "johny1122@gmail.com", "self": True},
            "organizer": {"email": "johny1122@gmail.com", "self": True},
            "start": {
                "dateTime": "2022-12-21T18:00:00+05:00",
                "timeZone": "Asia/Karachi",
            },
            "end": {
                "dateTime": "2022-12-21T18:30:00+05:00",
                "timeZone": "Asia/Karachi",
            },
            "iCalUID": "flp51c1hgj5l62389rh7cj763c@google.com",
            "sequence": 0,
            "reminders": {"useDefault": True},
            "eventType": "default",
        }
        ...
        url = reverse(
            "appointment_service-single-appointment",
            kwargs={"pk": "flp51c1hgj5l62389rh7cj763c"},
        )
        response = self.client.get(url)
    ...
    @mock.patch(
        "modules.django_google_appointment.appointment.services.GoogleAppointmentServices.GoogleAppointmentService.create_appointment"
    )
    def test_create_appointment(self, create_appointment_mock):
        responses = {
            "kind": "calendar#event",
            "etag": '"3348921118430000"',
            "id": "tv086jumcnlalu0df8npr9afck",
            "status": "confirmed",
            "htmlLink": "https://www.google.com/calendar/event?eid=dHYwODZqdW1jbmxhbHUwZGY4bnByOWFmY2sgamFtZ2hhZm9vcjExMjJAbQ",
            "created": "2023-01-23T07:55:59.000Z",
            "updated": "2023-01-23T07:55:59.215Z",
            ...
            "organizer": {"email": "johny1122@gmail.com", "self": True},
            "start": {
                "dateTime": "2023-06-28T21:00:00+05:00",
                "timeZone": "Asia/Karachi",
            },
            "end": {
                "dateTime": "2023-06-29T05:00:00+05:00",
                "timeZone": "Asia/Karachi",
            },
            "iCalUID": "tv086jumcnlalu0df8npr9afck@google.com",
            "sequence": 0,
            "attendees": [
                {"email": "johi@gmail.com", "responseStatus": "needsAction"},
                {"email": "david@gmail.com", "responseStatus": "needsAction"},
            ],
            "reminders": {"useDefault": True},
            "eventType": "default",
        }
        ...
        data = {
            ...
            "location": "800 Howard St., San Francisco, CA 94103",
            "description": "A chance to hear more about Google's developer products.",
            "start": {"dateTime": "2023-05-28T09:00:00-07:00"},
            "end": {"dateTime": "2023-05-28T17:00:00-07:00"},
            "attendees": [
    ...
    @mock.patch(
        "modules.django_google_appointment.appointment.services.GoogleAppointmentServices.GoogleAppointmentService.delete_appointment"
    )
    def test_delete_appointment(self, delete_appointment_mock):
        ...
        url = reverse(
            "appointment_service-delete-appointment",
            kwargs={"pk": "j64tek13uvml1kf3pp9foi3ijc"},
        )
    ...
    @mock.patch(
        "modules.django_google_appointment.appointment.viewsets.GoogleAppointmentService.appointment_list"
    )
    def test_sync_appointment(self, appointment_list_mock):
        responses = {
            "kind": "calendar#events",
            "etag": '"p32ccnjk0jrevo0g"',
            "summary": "johny1122@gmail.com",
            "updated": "2023-01-23T08:06:24.239Z",
            "timeZone": "Asia/Karachi",
            "accessRole": "owner",
            "defaultReminders": [{"method": "popup", "minutes": 30}],
            "nextSyncToken": "CJjLzoCe3fwCEJjLzoCe3fwCGAUg7JnJ7wE=",
            "items": [
                {
                    "kind": "calendar#event",
                    "etag": '"3301560614520000"',
    ...
    def test_synced_appointment_list(self):
        user = User.objects.create(
            username="david", email="david77@gmail.com", password="david123@"
        )
