"""
Django settings for ayat_48209 project.
...
WSGI_APPLICATION = 'ayat_48209.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ayat_48209 API",
    "DESCRIPTION": "API documentation for ayat_48209 App",
    "VERSION": "v1",
}
